...
use sinew_app::{
    ...
    write_workspace_file, write_workspace_image, AgentEvent, AgentMode, AppStore, BashTool,
    BrowserTools,
...
use sinew_opencode_go::{
    ...
    list_models as list_opencode_go_models_remote,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::save_workspace_image_command,
            ...
            providers::list_opencode_go_models,
